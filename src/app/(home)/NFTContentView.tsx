  ...
  return (
    <div className="flex h-auto w-full flex-col items-center">
      ...
      >
        ...
        {isOpen && (
          <div className="max-h-90vh fixed left-1/2 top-1/2 z-20 w-[calc(100%-32px)] max-w-[556px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-[#1A1A1AB2] to-[#071926B2] px-5 py-5">
            ...
            <p className="w-full text-center text-lg font-semibold leading-relaxed text-white md:text-2xl">
              {data.description}
            </p>
            <button
              type="button"
